...
const SeatBooking = ({ movieId }) => {
  ...
  const fetchBookedSeats = () => {
    ...
    axios
      .get(`http://localhost:8083/api/bookings/M001/2025-02-01/Morning`)
      .then((response) => {
        const bookedSeats = response.data.map((booking) => booking.seatNumber.toString());
  ...
  const toggleSeat = (seatNumber) => {
    if (soldSeats.includes(seatNumber.toString())) return;
  ...
  return (
    <div className="booking-container">
      <h2>Movie-Mate Theatre Showing Screen</h2>
